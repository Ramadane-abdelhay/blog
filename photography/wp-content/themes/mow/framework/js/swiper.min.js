    ...
    var Y = {
        ...
        R = {
            loopCreate: function(e) {
                ...
                l ? (s.loopAddBlankSlides ? (d(n - t.slides.length % n), t.recalcSlides(), t.updateSlides()) : g(), i()) : o ? (s.loopAddBlankSlides ? (d(s.grid.rows - t.slides.length % s.grid.rows), t.recalcSlides(), t.updateSlides()) : g(), i()) : i(), t.loopFix({
                    slideRealIndex: e,
            ...
            loopFix: function(e) {
                ...
                (d.length < f + w || b && "row" === m.grid.fill) && g();
                const y = [],
                    E = [];
                let x = o.activeIndex;
    ...
    const se = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = F.bind(e), e.onTouchMove = V.bind(e), e.onTouchEnd = _.bind(e), e.onDocumentTouchStart = Z.bind(e), t.cssMode && (e.onScroll = U.bind(e)), e.onClick = W.bind(e), e.onLoad = K.bind(e), Q(e, "on")
                },
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    d.style.zIndex = -Math.abs(Math.round(c)) + e.length, me(0, d).style.transform = S
                }
            },
            setTransition: e => {
                const s = t.slides.map((e => h(e)));

...
! function(e, t) {
    ...
    ! function() {
        ...
        t.prototype.init = function() {
            ...
            var o, s, i = null;
            if (this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? o = this.s.dynamicEl[t].subHtmlUrl : i = this.s.dynamicEl[t].subHtml : (s = this.$items.eq(t)).attr("data-sub-html-url") ? o = s.attr("data-sub-html-url") : (i = s.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !i && (i = s.attr("title") || s.find("img").first().attr("alt"))), !o)
                if (null != i) {
            ...
            if (c.s.dynamic) {
                if (c.s.dynamicEl[t].poster && (u = !0, r = c.s.dynamicEl[t].poster), d = c.s.dynamicEl[t].html, l = c.s.dynamicEl[t].src, c.s.dynamicEl[t].responsive) h(c.s.dynamicEl[t].responsive.split(","));
                a = c.s.dynamicEl[t].srcset, n = c.s.dynamicEl[t].sizes
            } else {
                if (c.$items.eq(t).attr("data-poster") && (u = !0, r = c.$items.eq(t).attr("data-poster")), d = c.$items.eq(t).attr("data-html"), l = c.$items.eq(t).attr("href") || c.$items.eq(t).attr("data-src"), c.$items.eq(t).attr("data-responsive")) h(c.$items.eq(t).attr("data-responsive").split(","));
            ...
            if (!c.$slide.eq(t).hasClass("lg-loaded")) {
                if (g) c.$slide.eq(t).prepend('<div class="lg-video-cont" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + l + '"  allowfullscreen="true"></iframe></div></div>');
                else if (u) {
                    var f;
                    f = m && m.youtube ? "lg-has-youtube" : m && m.vimeo ? "lg-has-vimeo" : "lg-has-html5", c.$slide.eq(t).prepend('<div class="lg-video-cont ' + f + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + r + '" /></div></div>')
                } else m ? (c.$slide.eq(t).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), c.$el.trigger("hasVideo.lg", [t, l, d])) : c.$slide.eq(t).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + l + '" /></div>');
            ...
            })), m && m.html5 && !u && c.$slide.eq(t).addClass("lg-complete"), !0 === o && (c.$slide.eq(t).hasClass("lg-complete") ? c.preload(t) : c.$slide.eq(t).find(".lg-object").on("load.lg error.lg", (function() {
                c.preload(t)
            })))
            ...
            if (!r.lGalleryOn || l !== t) {
                ...
                if (!r.lgBusy) {
                    ...
                    if (this.$el.trigger("onBeforeSlide.lg", [l, t, o, s]), r.lgBusy = !0, clearTimeout(r.hideBartimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout((function() {
                            r.addHtml(t)
                        }), n), this.arrowDisable(t), i || (t < l ? i = "prev" : t > l && (i = "next")), o) this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"), a > 2 ? (c = t - 1, u = t + 1, (0 === t && l === a - 1 || t === a - 1 && 0 === l) && (u = 0, c = a - 1)) : (c = 0, u = 1), "prev" === i ? r.$slide.eq(u).addClass("lg-next-slide") : r.$slide.eq(c).addClass("lg-prev-slide"), r.$slide.eq(t).addClass("lg-current");
            ...
            return this.each((function() {
                ...
                } catch (e) {} else e.data(this, "lightGallery", new t(this, o))
            }))
...
function(e, t) {
    ...
    ! function() {
        ...
        o.prototype.init = function() {
            ...
            t.core.s.actualSize && (o += '<span id="lg-actual-size" class="lg-icon"></span>'), t.core.s.useLeftForZoom ? t.core.$outer.addClass("lg-use-left-for-zoom") : t.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(o), t.core.$el.on("onSlideItemLoad.lg.tm.zoom", (function(o, s, i) {
            ...
            var s = 1,
                i = function(o) {
                    var s = t.core.$outer.find(".lg-current .lg-image"),
                        ...
                        l = (e(window).height() - s.prop("offsetHeight")) / 2 + e(window).scrollTop(),
                        r = (o - 1) * (t.pageX - i),
                        a = (o - 1) * (t.pageY - l);
                    s.css("transform", "scale3d(" + o + ", " + o + ", 1)").attr("data-scale", o), t.core.s.useLeftForZoom ? s.parent().css({
                        left: -r + "px",
                        top: -a + "px"
                    }).attr("data-x", r).attr("data-y", a) : s.parent().css("transform", "translate3d(-" + r + "px, -" + a + "px, 0)").attr("data-x", r).attr("data-y", a)
                },
                l = function() {
                    s > 1 ? t.core.$outer.addClass("lg-zoomed") : t.resetZoom(), s < 1 && (s = 1), i(s)
                },
                r = function(o, i, r, a) {
                    var n, d = i.prop("offsetWidth");
                    n = t.core.s.dynamic ? t.core.s.dynamicEl[r].width || i[0].naturalWidth || d : t.core.$items.eq(r).attr("data-width") || i[0].naturalWidth || d, t.core.$outer.hasClass("lg-zoomed") ? s = 1 : n > d && (s = n / d || 2), a ? (t.pageX = e(window).width() / 2, t.pageY = e(window).height() / 2 + e(window).scrollTop()) : (t.pageX = o.pageX || o.originalEvent.targetTouches[0].pageX, t.pageY = o.pageY || o.originalEvent.targetTouches[0].pageY), l(), setTimeout((function() {
            ...
            e.core.$slide.on("touchstart.lg", (function(o) {
                if (e.core.$outer.hasClass("lg-zoomed")) {
                    ...
                    l = s.prop("offsetHeight") * s.attr("data-scale") > e.core.$outer.find(".lg").height(), ((i = s.prop("offsetWidth") * s.attr("data-scale") > e.core.$outer.find(".lg").width()) || l) && (o.preventDefault(), t = {
            ...
            (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) && (s && (n <= -c ? n = -c : n >= -d && (n = -d)), o && (a <= -h ? a = -h : a >= -u && (a = -u)), s ? l.attr("data-y", Math.abs(n)) : n = -Math.abs(l.attr("data-y")), o ? l.attr("data-x", Math.abs(a)) : a = -Math.abs(l.attr("data-x")), i.core.s.useLeftForZoom ? l.css({
                left: a + "px",
                top: n + "px"
    ...
    ! function() {
        ...
        o.prototype.init = function() {
            ...
            if (s.core.$outer.addClass("lg-has-thumb"), s.core.$outer.find(".lg").append('<div class="lg-thumb-outer"><div class="lg-thumb lg-group"></div></div>'), s.$thumbOuter = s.core.$outer.find(".lg-thumb-outer"), s.thumbOuterWidth = s.$thumbOuter.width(), s.core.s.animateThumb && s.core.$outer.find(".lg-thumb").css({
                ...
                for (var r = 0; r < s.core.s.dynamicEl.length; r++) t(s.core.s.dynamicEl[r].src, s.core.s.dynamicEl[r].thumb, r);
            ...
            s.core.$outer.find(".lg-thumb").html(i), (o = s.core.$outer.find(".lg-thumb-item")).each((function() {
                var t = e(this),
            ...
            e.core.$outer.find(".lg-thumb").on("touchstart.lg", (function(o) {
                ...
                e.thumbTotalWidth > e.thumbOuterWidth && (l.preventDefault(), o = l.originalEvent.targetTouches[0].pageX, s = !0, e.$thumbOuter.addClass("lg-dragging"), i = e.left, (i -= o - t) > e.thumbTotalWidth - e.thumbOuterWidth && (i = e.thumbTotalWidth - e.thumbOuterWidth), i < 0 && (i = 0), e.setTranslate(i))
...
function(e, t) {
    ...
    ! function(e, t, o, s) {
        ...
        }, e.fn.lightGallery.modules.fullscreen = l
        ...
        l.prototype.init = function() {
            ...
            t.core.$el.on("hasVideo.lg.tm", (function(e, o, s, i) {
                if (t.core.$slide.eq(o).find(".lg-video").append(t.loadVideo(s, "lg-object", !0, o, i)), i)
                    ...
                    } catch (e) {} else t.core.$slide.eq(o).find(".lg-html5").get(0).play()
                ...
                if (e.find(".lg-object").hasClass("lg-has-poster") && e.find(".lg-object").is(":visible"))
                    if (e.hasClass("lg-has-video")) {
                        ...
                        if (o) o.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*");
                                ...
                                $f(s).api("play")
                            } catch (e) {} else if (i) i.contentWindow.postMessage("play", "*");
                            else if (l)
                            if (t.core.s.videojs) try {
                                videojs(l).play()
                            } catch (e) {} else l.play();
                        ...
                        var r = function(o, s) {
                            if (e.find(".lg-video").append(t.loadVideo(o, "", !1, t.core.index, s)), s)
                                ...
                                } catch (e) {} else t.core.$slide.eq(t.core.index).find(".lg-html5").get(0).play()
                        };
            ...
            t.core.doCss() && t.core.$items.length > 1 && (t.core.s.enableSwipe && t.core.isTouch || t.core.s.enableDrag && !t.core.isTouch) ? t.core.$el.on("onSlideClick.lg.tm", (function() {
                ...
                if (a) a.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*");
                        ...
                        $f(n).api("pause")
                    } catch (e) {} else if (d) d.contentWindow.postMessage("pause", "*");
                    else if (u)
                    if (t.core.s.videojs) try {
                        videojs(u).pause()
                    } catch (e) {} else u.pause();
                c && e(c).attr("src", e(c).attr("src").replace("&autoplay", "&noplay")), l = t.core.s.dynamic ? t.core.s.dynamicEl[i].src : t.core.$items.eq(i).attr("href") || t.core.$items.eq(i).attr("data-src");
                var h = t.core.isVideo(l, i) || {};

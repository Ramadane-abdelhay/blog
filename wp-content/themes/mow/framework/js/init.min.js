    ...
    var t = {
        ...
        o = {
            ...
            progressF: function(t) {
                t.find(".fn__rbox_progress_item").each((function(t) {
                    var n = e(this).find(".fn__rbox_progress_box"),
